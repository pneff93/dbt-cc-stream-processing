...
The goal is to implement, test, and deploy a stream processing pipeline with Flink SQL using the [Confluent dbt adapter](https://github.com/confluentinc/dbt-confluent).
